...
export const sendSecurityNotice = async (cleanUser) => {
    const emailContent = `                                                                                                                   <div style="font-family: Arial, sans-serif; font-size: 15px; color: #333; line-height: 1.6; max-width: 600px; margin: auto;">                <h2 style="color: #0052cc;">Security Alert: Sign-Up Attempt Using Your Email</h2>
        ...
        <p> We noticed an attempt to create an account using your email address: <strong>user@example.com</strong>. </p>                         <p> If you initiated this sign-up, feel free to ignore this message. But if you did not, rest assured — no account has been cre      ated, and your email address remains secure in our system. </p>
